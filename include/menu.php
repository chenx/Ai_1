...
function writeMenu() {
    ...
    $s .= "<li$current><a href='{$base_url}index.php'>Home</a>";

    $current = ( ($page_title == "About Us") ? " class='current'" : "" );
    $s .= "<li$current><a href='{$base_url}about.php'>About Us</a>";
    ...
    if (isset($_SESSION['role']) && $_SESSION['role'] == "admin") {
        if ($page_title == "Site Admin") {
            ...
            $s .= "<li $current><a href='{$base_url}adminhome.php'>Site Admin</a>";
        }
        $s .= "<ul>";
        $s .= "<li><a href='{$base_url}admin_users.php'>Manage Users</a></li>";
        //$s .= "<li><a href='{$base_url}admin_images.php'>Manage Images</a></li>";
        $s .= "<li><a href='#' onclick='javascript: open_file(\"admin_images.php\");'>Manage Images</a></li>";
        $s .= "<li><a href='{$base_url}admin_create_schema.php'>Create Schema For Tables</a></li>";
        $s .= "<li><a href='{$base_url}admin_dump_table.php'>Dump Contents Of Tables</a></li>";
        $s .= "<li><a href='{$base_url}admin_backup_db.php'>Backup Database</a></li>";
        $s .= "</ul>";
        $s .="</li>";
    }
    ...
    if (isset($_SESSION['username'])) {
        if ($page_title == "Member Home") {
            ...
            $s .= "<li><a href='{$base_url}home.php'>Member Home</a></li>";
        }

        if ($page_title == "My Profile") {
            $s .= "<li class='current'><a href='#'>My Profile</a></li>";
        } else {
            $s .= "<li><a href='{$base_url}profile.php'>My Profile</a></li>";
        }

        $t = "<a href='{$base_url}logout.php'>Log out</a>";
        $s .= "<li>$t</li>";
    }
